  ...
  navbarPage(
    ...
    tabPanel(
      ...
      h3("This project seeks to visualize CO2 data collected by the Our World in Data project. 
         ...
         growth of CO2 by GDP? What is the energy per GDP by population? What is the energy per capita by poulation? 
      ...
      h4("the highest consumers of CO2 are ", highest_co2_consumer),
      h4("and its GDP is ", highest_co2_consumer_gdp),
      h4("the highest producers of CO2 are ", highest_co2_producer),
      h4("and its GDP is ", highest_co2_producer_gdp),
      h4("the highest consumers of CO2 are ", lowest_co2_consumer),
      h4("and its GDP is ", lowest_co2_consumer_gdp),
      h4("the highest producers of CO2 are ", lowest_co2_producer),
      h4("and its GDP is ", lowest_co2_producer_gdp),
      h3("Particularly, the aim of these calculations is to show the disparity of CO2 consumption and production by 
         ...
         consumption/production when compared with themore affluent countries.")
    ),
    tabPanel(
      "CO2 Viewer",
      co2_input,
